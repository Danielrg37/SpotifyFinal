...
function VistaAdminArtista() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setArtistaID(searchResults[0].id);
      } catch (error) {
        console.log(error);
      }
    };
  ...
  // Codigo para obtener la canción y vista, mirar de optimizarlo si puedo tener tiempo pero lo siento, voy justo.
  // En plan, pasarlo al useParams no me está dejando y
